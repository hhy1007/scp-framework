...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	private static String[] parsePatterns = { PATTERN_YMD,
	...
	public static String formatDate(Date date, Object... pattern) {
		...
		if (pattern != null && pattern.length > 0) {
			...
			formatDate = DateFormatUtils.format(date, PATTERN_YMD);
		}
		return formatDate;
	}
	...
	public static String formatDateTime(Date date) {
		return formatDate(date, DATE_FMT_Y_M_D_HMSS);
	}
	...
	public static String getDateTime() {
		return formatDate(new Date(), DATE_FMT_Y_M_D_HMSS);
	}
	...
	public static double getDistanceOfTwoDate(Date before, Date after) {
		...
		return (double) (afterTime - beforeTime) / (1000L * 60 * 60 * 24);  
	}
